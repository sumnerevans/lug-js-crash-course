...
\begin{frame}
    ...
    Basically, if you want to do anything in JavaScript, somebody else has probably also wanted to
    do that and have created a library for it. Google is your friend.
